...
1. Set up the `MAVENMOVIES` database in MySQL Workbench (or your preferred MySQL client).
2. Run the queries in `maven_movies_analysis.sql` sequentially, or execute individual sections as needed.
3. Results will populate directly from your live database instance.
